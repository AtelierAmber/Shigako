...
struct qt_meta_stringdata_ShigakoSlider_t {
    QByteArrayData data[4];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ShigakoSlider_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ShigakoSlider_t qt_meta_stringdata_ShigakoSlider = {
    {
QT_MOC_LITERAL(0, 0, 13), // "ShigakoSlider"
QT_MOC_LITERAL(1, 14, 9), // "editValue"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3) // "val"

    },
    "ShigakoSlider\0editValue\0\0val"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ShigakoSlider[] = {
...
void ShigakoSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ShigakoSlider *_t = static_cast<ShigakoSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->editValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ShigakoSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_ShigakoSlider.data,
      qt_meta_data_ShigakoSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *ShigakoSlider::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *ShigakoSlider::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ShigakoSlider.stringdata0))
        return static_cast<void*>(const_cast< ShigakoSlider*>(this));
    return QSlider::qt_metacast(_clname);
}

int ShigakoSlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
